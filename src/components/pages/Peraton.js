        ...
        <div className='portfolio-container'>
            ...
            <div className='portfolio-page-description-container'>
                <div className='portfolio-page-description'>
                    ...
                    <div className='portfolio-page-pic-caption'>An excerpt from my solution presentation</div>
                    ...
                    <div className='portfolio-page-pic-caption'>An example of SEL SynchroWAVe Event Software</div>
